                ...
                "/xion.v1.Query/WebAuthNVerifyRegister" => {
                        ...
                        for WebAuthNVerifyRegisterSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Query>::web_auth_n_verify_register(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xion.v1.Query/WebAuthNVerifyAuthenticate" => {
                        ...
                        for WebAuthNVerifyAuthenticateSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::web_auth_n_verify_authenticate(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xion.v1.Query/PlatformPercentage" => {
                        ...
                        for PlatformPercentageSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::platform_percentage(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xion.v1.Query/PlatformMinimum" => {
                        ...
                        for PlatformMinimumSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Query>::platform_minimum(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xion.v1.Msg/SetPlatformPercentage" => {
                        ...
                        for SetPlatformPercentageSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Msg>::set_platform_percentage(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xion.v1.Msg/SetPlatformMinimum" => {
                        ...
                        for SetPlatformMinimumSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Msg>::set_platform_minimum(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
