...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::QueryParamsResponse>, tonic::Status>
        {
            ...
            let path = http::uri::PathAndQuery::from_static("/xion.mint.v1.Query/Params");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("xion.mint.v1.Query", "Params"));
        ...
        ) -> core::result::Result<tonic::Response<super::QueryInflationResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/xion.mint.v1.Query/Inflation");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("xion.mint.v1.Query", "Inflation"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/xion.mint.v1.Query/AnnualProvisions");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("xion.mint.v1.Query", "AnnualProvisions"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod query_server {
    ...
    impl<T: Query> tonic::server::NamedService for QueryServer<T> {
        const NAME: &'static str = "xion.mint.v1.Query";
    }
}
/// Generated client implementations.
#[cfg(feature = "grpc")]
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::MsgUpdateParamsResponse>, tonic::Status>
        {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/xion.mint.v1.Msg/UpdateParams");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("xion.mint.v1.Msg", "UpdateParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod msg_server {
    ...
    impl<T: Msg> tonic::server::NamedService for MsgServer<T> {
        const NAME: &'static str = "xion.mint.v1.Msg";
    }
}
