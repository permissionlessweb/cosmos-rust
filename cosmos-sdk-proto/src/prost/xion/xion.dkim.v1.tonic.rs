...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::QueryDkimPubKeyResponse>, tonic::Status>
        {
        ...
        ) -> core::result::Result<tonic::Response<super::QueryDkimPubKeysResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> core::result::Result<tonic::Response<super::AuthenticateResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                ...
                "/xion.dkim.v1.Query/DkimPubKey" => {
                    ...
                    impl<T: Query> tonic::server::UnaryService<super::QueryDkimPubKeyRequest> for DkimPubKeySvc<T> {
                        ...
                        fn call(
                            ...
                            let fut =
                                async move { <T as Query>::dkim_pub_key(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xion.dkim.v1.Query/DkimPubKeys" => {
                    ...
                    impl<T: Query> tonic::server::UnaryService<super::QueryDkimPubKeysRequest> for DkimPubKeysSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as Query>::dkim_pub_keys(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/xion.dkim.v1.Query/Authenticate" => {
                    ...
                    impl<T: Query> tonic::server::UnaryService<super::QueryAuthenticateRequest> for AuthenticateSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as Query>::authenticate(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        ) -> core::result::Result<tonic::Response<super::MsgAddDkimPubKeysResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> core::result::Result<tonic::Response<super::MsgRemoveDkimPubKeyResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
        ...
        ) -> core::result::Result<tonic::Response<super::MsgRevokeDkimPubKeyResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::new(
                    tonic::Code::Unknown,
                ...
                "/xion.dkim.v1.Msg/AddDkimPubKeys" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgAddDkimPubKeys> for AddDkimPubKeysSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut =
                                async move { <T as Msg>::add_dkim_pub_keys(&inner, request).await };
                            Box::pin(fut)
                        }
                    }
                    let accept_compression_encodings = self.accept_compression_encodings;
                ...
                "/xion.dkim.v1.Msg/RemoveDkimPubKey" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgRemoveDkimPubKey> for RemoveDkimPubKeySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Msg>::remove_dkim_pub_key(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/xion.dkim.v1.Msg/RevokeDkimPubKey" => {
                    ...
                    impl<T: Msg> tonic::server::UnaryService<super::MsgRevokeDkimPubKey> for RevokeDkimPubKeySvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Msg>::revoke_dkim_pub_key(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
